<!-- 
    ...
    Beskrivelse: Vi kun skrevet notat om hvem som har bidratt på filen i Australia.xsl fordi de andre xsl filene med land er helt like.
        Eneste forskjellen er variabelen "landkoder".
...
<xsl:variable name="landkoder">AUS</xsl:variable>
